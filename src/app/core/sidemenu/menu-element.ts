export const menus = [
        ...
        'sub': [
            {
                'name': 'Book a service',
                'icon': 'filter_list',
                'link': 'reports/Book-a-service',
                'open': false,
            },
            {
                'name': 'Sale enquiry',
                'icon': 'done_all',
                'link': 'reports/Sale-enquiry',
                'open': false,
            },
            {
                'name': 'Service center feedback',
                'icon': 'filter_center_focus',
                'link': 'reports/Service-center-feedback',
                'open': false,
            },
            {
              'name': 'Showroom feedback',
              'icon': 'view_week',
              'link': 'reports/showroom-table',
              'open': false,
          }
    ...
    // }
   // ,
   //this is changing the pages to my requirement for admin panel
    {
        'name': 'Admin',
        'icon': 'content_copy',
        'open': false,
        ...
        'sub': [
            {
                'name': 'Update mangers details',
                'icon': 'work',
                'open': false,
                'link': 'pages/Update-mangers-details',
            }, {
                'name': 'Add hoilday data',
                'icon': 'local_laundry_service',
                'open': false,
                'link': 'pages/add-hoilday-data',
            }, {
                'name': 'Delete hoilday list',
                'icon': 'directions',
                'open': false,
                'link': 'pages/delete-hoilday-list'
            }
        ]
    }
    ,
